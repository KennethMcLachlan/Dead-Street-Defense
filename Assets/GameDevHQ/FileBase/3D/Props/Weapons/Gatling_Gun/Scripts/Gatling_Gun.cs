...
namespace GameDevHQ.FileBase.Gatling_Gun
{
    ...
    public class Gatling_Gun : MonoBehaviour
    {
        ...
        void Update()
        {
            if (Input.GetMouseButton(0)) //Check for left click (held) user input         ||        Rewrite to activatate when enemy is in range*************
            { 
            ...
            //Add Look At Script to look at the enemy that is in range *******************
        }
